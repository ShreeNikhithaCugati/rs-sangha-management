...
export default function SanghasPage() {
  ...
  if (loading) {
    return (
      <div style={{ color: 'white', fontSize: '18px', padding: '40px' }}>
        Loading sanghas...
      </div>
    )
  }
    ...
    <div>
      ...
      {sanghas.length === 0 ? (
        <div style={{
          ...
          <p style={{ color: '#a5b4fc', fontSize: '16px' }}>No sanghas created yet.</p>
          <button
            onClick={() => router.push('/dashboard/superadmin')}
            style={{
            ...
            <table style={{
              ...
              <thead>
                <tr style={{
                  ...
                  <th style={{ padding: '14px 16px', textAlign: 'left', color: '#a5b4fc', fontSize: '12px', fontWeight: '600' }}>
                    ID
                  </th>
                  <th style={{ padding: '14px 16px', textAlign: 'left', color: '#a5b4fc', fontSize: '12px', fontWeight: '600' }}>
                    Name
